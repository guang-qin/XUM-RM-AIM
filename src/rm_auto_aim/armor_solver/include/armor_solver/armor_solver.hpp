...
#ifndef ARMOR_SOLVER__ARMOR_SOLVER_HPP_
#define ARMOR_SOLVER__ARMOR_SOLVER_HPP_
...
public:
  ...
  auto_aim_interfaces::msg::GimbalCmd solve(const auto_aim_interfaces::msg::Target &target_msg,
