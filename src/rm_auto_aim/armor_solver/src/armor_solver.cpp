...
auto_aim_interfaces::msg::GimbalCmd Solver::solve(const auto_aim_interfaces::msg::Target &target,
  ...
  // RCLCPP_INFO(rclcpp::get_logger("armor_solver"), "Get newest parameters");
  ...
  // RCLCPP_INFO(rclcpp::get_logger("armor_solver"), "Get current roll, yaw and pitch of gimbal");
  ...
  // RCLCPP_INFO(rclcpp::get_logger("armor_solver"), "Calculate yaw, pitch, distance");
